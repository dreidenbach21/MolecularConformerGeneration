...
class PabloEscobar():
    def __init__(self, model):
        ...
        weights = "Perfect_Angle"
        self.mole_name = "CC_DRUGS_testset_" + weights  + suffix
    ...
    def generate(self):
        ...
        print("No Ar Generation Complete")
...
def main(cfg: DictConfig): #['encoder', 'decoder', 'vae', 'optimizer', 'losses', 'data', 'coordinates', 'wandb']
    model = VAENoArAngle(cfg.vae, cfg.encoder, cfg.decoder, cfg.losses, cfg.coordinates, device = "cuda").cuda()
